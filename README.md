...
## 📌 Backlog Inicial
- [ ] Criar identidade visual inicial do projeto
- [ ] Definir arquitetura da informação
- [ ] Criar página inicial
- [ ] Criar página institucional
- [ ] Criar seção de linhas de pesquisa
- [ ] Criar seção de publicações
- [ ] Criar agenda de eventos
- [ ] Criar área para interessados
- [ ] Criar dashboards acadêmicos
